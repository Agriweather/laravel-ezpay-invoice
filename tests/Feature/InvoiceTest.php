...
test('發票開立 → 測試斷言開立 B2B 發票', function () {
    EzPayInvoice::fake([
        CreateResult::make([
            'Status' => 'SUCCESS',
            'Message' => '發票開立成功',
...
test('發票開立 → 測試斷言開立發票並等待觸發', function () {
    EzPayInvoice::fake([
        CreateResult::make([
            'Status' => 'SUCCESS',
            'Message' => '發票開立成功',
...
test('發票查詢 → 測試斷言透過發票號碼及隨機碼查詢發票', function () {
    EzPayInvoice::fake([
        QueryResult::make([
            'Status' => 'SUCCESS',
            'Message' => '查詢成功',
...
test('發票查詢 → 測試斷言透過訂單編號及發票金額查詢發票', function () {
    EzPayInvoice::fake([
        QueryResult::make([
            'Status' => 'SUCCESS',
            'Message' => '查詢成功',
...
test('發票觸發 → 測試斷言觸發等待中的發票', function () {
    EzPayInvoice::fake([
        TriggerResult::make([
            'Status' => 'SUCCESS',
            'Message' => '觸發開立發票成功',
...
test('發票作廢 → 測試斷言作廢已開立的發票', function () {
    EzPayInvoice::fake([

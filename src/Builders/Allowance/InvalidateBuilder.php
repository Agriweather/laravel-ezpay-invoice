...
use Agriweather\EzPayInvoice\Options\Allowance\InvalidateQueryOptions;
use Agriweather\EzPayInvoice\Results\Allowance\InvalidateResult;

class InvalidateBuilder extends Builder
{
    protected InvalidateQueryOptions $options;

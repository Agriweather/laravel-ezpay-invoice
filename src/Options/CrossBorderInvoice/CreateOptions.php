...
class CreateOptions extends Options
{
     ...
     * 檢查是否存在商品項目。
     */
    public function hasItem(string $name, int|float $quantity, string $unit, int|float $price, int|float $amount): bool
    {
    ...
    public function toArray()
    {
        return [
            ...
            'PostData_' => array_filter([
                ...
                'ItemCount' => implode('|', array_map(function (int|float $quantity) {
